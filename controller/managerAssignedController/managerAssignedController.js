    ...
    try {
        ...
        const formattedData = issueAssignments.map(issue => {
            ...
            return {
                ...
                no_of_options_provided: issue.no_of_options_provided,
                no_of_words_written: issue.no_of_words_written,
                options_submitted: issue.options_submitted,
                concept_work: issue.concept_work,
                resize_work: issue.resize_work,
                no_of_concepts: issue.no_of_concepts,
                duration_minutes: issue.duration_minutes,
                duration_seconds: issue.duration_seconds,
                product_shoot: issue.product_shoot,
                no_of_products_shot: issue.no_of_products_shot,
                shoot_setup: issue.shoot_setup,
                no_of_resize: issue.no_of_resize,
                responsive_screen: issue.responsive_screen,
                no_of_responsive_screen: issue.no_of_responsive_screen,
                no_of_images_videos_audio: issue.no_of_images_videos_audio,
